...
<body class="bg-smart-bg text-white min-h-screen flex items-center justify-center p-4 selection:bg-smart-red selection:text-white">
  ...
  <div class="w-full max-w-md space-y-6">
    ...
    <div class="text-center space-y-2">
      ...
      <h1 class="text-2xl font-extrabold tracking-tight uppercase">NUEVA CONTRASEÑA</h1>
      <p class="text-xs text-smart-text-muted uppercase">INGRESA TU NUEVA CLAVE DE ACCESO PARA ACTUALIZARLA</p>
    </div>
    ...
    <div class="bg-smart-card border border-smart-border rounded-2xl p-6 shadow-2xl space-y-5">
      <form action="<?= base_url('login/update-password') ?>" method="POST" class="space-y-4">
        ...
        <div class="space-y-1.5">
          <label for="password" class="text-xs font-bold uppercase tracking-wider text-smart-text-muted">NUEVA CONTRASEÑA</label>
          <div class="relative">
        ...
        <div class="space-y-1.5">
          <label for="confirm_password" class="text-xs font-bold uppercase tracking-wider text-smart-text-muted">CONFIRMAR CONTRASEÑA</label>
          <div class="relative">
            <span class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-smart-text-muted text-lg">enhanced_encryption</span>
            <input 
              type="password" 
              id="confirm_password" 
    ...
    <p class="text-center text-xs text-smart-text-muted uppercase">
      ¿RECORDASTE TU CLAVE? 
      <a href="<?= base_url('login') ?>" class="text-white font-bold hover:underline uppercase inline-flex items-center gap-1 ml-1">
        VOLVER AL LOGIN
      </a>
    </p>
